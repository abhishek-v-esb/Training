...
function getExistingData() {
  ...
  xhr.open("GET", `http://localhost:8097/update?id=1`, true);
...
form.addEventListener("submit", (event) => {
  ...
  xhr.onload = () => {
    window.location.href = "http://localhost:8097/display";
  };
});
...
function selectedState(e) {
  ...
  if (e == undefined) {
    type = "states";
    url = "http://localhost:8097/states";
    ...
    url = `http://localhost:8097/cities?state=${e.selectedIndex}`;
  }
  var xhr = new XMLHttpRequest();
